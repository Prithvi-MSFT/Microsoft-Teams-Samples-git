...
**Note:** Required admin consent for samples where asterisk (*) added as suffix with sample name. Please follow the [link](https://learn.microsoft.com/en-us/azure/active-directory/manage-apps/grant-admin-consent?pivots=portal) to provide admin consent.
