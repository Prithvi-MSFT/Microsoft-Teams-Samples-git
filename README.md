...
|20| Tab app monetization | This sample shows how to open purchase dialog and trigger purchase flow using teams-js sdk. ||[View][tab-app-monetization#nodejs]||[View](/samples/tab-app-monetization/csharp/demo-manifest/tab-app-monetization.zip)
...
|3|Graph API Teams App Installation Life Cycle | This sample illustrates how you can use [Teams App Installation Life Cycle](https://docs.microsoft.com/en-us/graph/api/resources/teamsappinstallation?view=graph-rest-1.0) by calling Microsoft Graph APIs.                              |[View][graph#instllationlifecycle#cs]       |[View][graph#instllationlifecycle#js] |[View](/samples/graph-app-installation-lifecycle/csharp/demo-manifest/graph-app-installation-lifecycle.zip)
...
|3|Complete Sample      | Sample covering multiple scenarios - dialogs, ME, and facebook auth.                                      |[View][app-complete#cs]        |[View][app-complete#ts]|[View](/samples/app-complete-sample/csharp/demo-manifest/Complete-Sample.zip)
|4|Meetings Extensibility | Microsoft Teams meeting extensibility sample: token passing |[View][meetings-token-app#cs]     |[View][meetings-token-app#js]|[View](/samples/meetings-token-app/csharp/demo-manifest/meetings-token-app.zip)
|5|Meetings Content Bubble Bot | Microsoft Teams meeting extensibility sample for iteracting with Content Bubble Bot in-meeting |[View][meetings-content-bubble#cs]    |[View][meetings-content-bubble#js]|[View](/samples/meetings-content-bubble/csharp/demo-manifest/meetings-content-bubble.zip)
...
|24|App complete auth|This sample demos authentication feature in bot,tab and messaging extension.|[View][app-complete-auth#cs]|[View][app-complete-auth#nodejs]|[View](/samples/app-complete-auth/csharp/demo-manifest/App-Complete-Auth.zip)
...
|26|Live coding interview using Shared meeting stage |This sample demos a live coding in a teams meeting stage.|[View][meetings-live-code-interview#csharp]|[View][meetings-live-code-interview#nodejs]|[View](/samples/meetings-live-code-interview/csharp/demo-manifest/meetings-live-code-interview.zip)
...
|28|Meeting Context App |This sample shows the contents of meeting tab context object in a meeting tab and shows the output of Meeting's API.|[View][meetings-context-app#csharp]|[View][meetings-context-app#js]|[View](/samples/meetings-context-app/csharp/demo-manifest/meetings-context-app.zip)
...
[meetings-context-app#js]:samples/meetings-context-app/nodejs
