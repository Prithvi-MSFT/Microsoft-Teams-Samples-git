...
**Note**: If you are facing any issue in your app, [please uncomment this line](https://github.com/OfficeDev/Microsoft-Teams-Samples/blob/main/samples/msgext-action/csharp/AdapterWithErrorHandler.cs#L25) and put your debugger for local debug.
